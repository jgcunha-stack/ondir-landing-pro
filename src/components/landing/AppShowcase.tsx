...
const AppShowcase = () => {
  return (
    <section id="app-showcase" className="relative py-20 md:py-32 bg-background overflow-hidden">
          ...
          >
            ...
            <div className="relative flex-1 flex justify-center">
              ...
              <div className={`absolute top-1/2 -translate-y-1/2 ${
                item.imagePosition === "left" ? "-right-20 lg:-right-32" : "-left-20 lg:-left-32"
              } w-[400px] md:w-[500px] lg:w-[600px] h-[400px] md:h-[500px] lg:h-[600px]`}>
                <div className="w-full h-full bg-gradient-to-br from-brand-400 to-brand-600 rounded-full opacity-90" />
              </div>

              {/* Floating badges */}
              <div className={`hidden md:block absolute ${
                item.imagePosition === "left" ? "right-[10%]" : "left-[10%]"
              } top-[15%] bg-white rounded-2xl px-4 py-3 shadow-xl border border-brand-100/50 animate-float z-20`}>
              ...
              <div className={`hidden md:block absolute ${
                item.imagePosition === "left" ? "left-[5%]" : "right-[5%]"
              } bottom-[20%] bg-white rounded-2xl px-4 py-3 shadow-xl border border-brand-100/50 animate-float-slow z-20`} style={{ animationDelay: '1s' }}>
                <div className="flex items-center gap-2">
